...
class client: NSObject, URLSessionDelegate, URLSessionTaskDelegate, URLSessionDataDelegate, URLSessionDownloadDelegate{
    ...
    func fetchImagesFromFlicker(keyword:String, ofPage page:Int, apiCompletionHandler: @escaping ResutOrError)
    {
        let parameters = [
            Constants.FlickrParameterKeys.Method:Constants.FlickrParameterValues.SearchMethod,
            Constants.FlickrParameterKeys.APIKey: Constants.FlickrParameterValues.APIKey,
            Constants.FlickrParameterKeys.KeyWord: keyword,
    ...
    func downloadPhotos(forList photosList: [[String:Any]],resolution:String)
    {
